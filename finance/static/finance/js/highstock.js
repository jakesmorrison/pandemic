                ...
                if (u !== a.textCache) {
                    ...
                    c || O || H || E || -1 !== e.indexOf(" ") ? (f = /<.*class="([^"]+)".*>/, p = /<.*style="([^"]+)".*>/, z = /<.*href="([^"]+)".*>/, J && J.appendChild(d), e = c ? e.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g) : [e], e = v(e, function(a) {
                        ...
                        b(c, function(k) {
                            if ("" !== k || 1 === c.length) {
                                var b = {},
                                    y = l.createElementNS(B.SVG_NS, "tspan"),
                                    v, w;
    ...
    (function(a) {
        ...
        h(c.prototype, {
            getTransformKey: function() {
                return r &&
                    !/Edge/.test(l.navigator.userAgent) ? "-ms-transform" : u ? "-webkit-transform" : x ? "MozTransform" : l.opera ? "-o-transform" : ""
            },
            html: function(a, c, f) {
        ...
        a.Tick.prototype = {
            ...
            getLabelPosition: function(a, h, n, f, c, l, b, g) {
                ...
                G(m) || (m = 0 === p.side ? n.rotation ?
                    -8 : -n.getBBox().height : 2 === p.side ? E.y + 8 : Math.cos(n.rotation * x) * (E.y - n.getBBox(!1, 0).height / 2));
            ...
            renderLabel: function(a, n, A, f) {
                var c = this.axis,
                    ...
                    w = a.x;
                a = a.y;
                g && q(w) && (g.xy = a = this.getLabelPosition(w, a, g, l, p, c, f, v), this.isFirst &&
                    !this.isLast && !h(b.showFirstLabel, 1) || this.isLast && !this.isFirst && !h(b.showLastLabel, 1) ? e = !1 : !l || p.step || p.rotation || n || 0 === A || this.handleOverflow(a), v && f % v && (e = !1), e && q(a.y) ? (a.opacity = A, g[this.isNewLabel ? "attr" : "animate"](a), this.isNewLabel = !1) : (g.attr("y", -9999), this.isNewLabel = !0))
            },
        ...
        a.extend(F.prototype, {
            ...
            adjustTickAmount: function() {
                ...
                if (this.hasData()) {
                    ...
                    } else g > b && (this.tickInterval *= 2, this.setTickPositions());
                    if (r(e)) {
                ...
                C(f.slice(0, c.length + 1), function(a, f) {
                    if (!1 !== a) {
                        ...
                        var m = f.series || l,
                            z = m.tt,
                            I = f.series || {},
                            K = "highcharts-color-" + x(f.colorIndex, I.colorIndex, "none");
            ...
            findNearestKDPoint: function(a, b, g) {
                ...
                x(a, function(a) {
                    ...
                    if ((m = c(a, !0)) && !(m = !c(e, !0))) var m = e.distX - a.distX,
                        ...
                        m = 0 < (0 !== m && b ? m : 0 !== f ? f : 0 !== p ? p : e.series.index >
                            a.series.index ? -1 : 1);
                    m && (e = a)
                });
                return e
        ...
        D(a.Pointer.prototype, {
            ...
            pinch: function(a) {
                var r = this,
                    ...
                    g = r.selectionMarker,
                    p = {},
                    v = 1 === c && (r.inClass(a.target, "highcharts-tracker") && u.runTrackerClick || r.runChartClick),
                    e = {};
                1 < c && (r.initiated = !0);
    ...
    (function(a) {
        ...
        G.prototype.getStacks = function() {
            ...
            h(a.series, function(c) {
                !c.options.stacking ||
                    !0 !== c.visible && !1 !== a.options.chart.ignoreHiddenSeries || (c.stackKey = c.type + u(c.options.stack, ""))
            })
        };
    ...
    (function(a) {
        ...
        a("spline", "line", {}, {
            getPointSpline: function(a, D, q) {
                ...
                q = a[q + 1];
                var r, u, A, f;
                if (x && !x.isNull && !1 !== x.doCurve && !D.isCliff && q && !q.isNull && !1 !== q.doCurve &&
                    !D.isCliff) {
                    a = x.plotY;
                    A = q.plotX;
                    q = q.plotY;
        ...
        a(C.prototype, "render", function() {
            ...
            G(this.yAxis || [], function(h) {
                h.options.stackLabels &&
                    !h.options.stackLabels.allowOverlap && D(h.stacks, function(h) {
                        D(h, function(h) {
                            a.push(h.label)
                        })
                    })
        ...
        r(p.prototype, {
            ...
            setState: function(a, b) {
                var c = Math.floor(this.plotX),
                    e = this.plotY,
                    f = this.series,
                    m = f.options.states[a || "normal"] || {},
                    d = h[f.type].marker && f.options.marker,
                    l = d && !1 === d.enabled,
            ...
            beforeSetTickPositions: function() {
                ...
                if (p || r) {
                    h(this.series, function(b, c) {
                        if (!(z &&
                                !1 === b.visible || !1 === b.takeOrdinalPosition && !r) && (f = f.concat(b.processedXData), a = f.length, f.sort(function(a, b) {
                                return a - b
        ...
        C.prototype = {
            ...
            render: function(b, c, e, f) {
                ...
                if (!this.hasDragged || x(e)) {
                    ...
                    this.size = t = m = w(l.len,
                        (k ? d.plotHeight : d.plotWidth) - 2 * h);
                    d = k ? h : m + 2 * h;
        ...
        C.prototype = {
            clickButton: function(a, c) {
                var g = this,
                    ...
                    l = g.buttonOptions[a],
                    m = h.xAxis[0],
                    n = h.scroller && h.scroller.getUnionExtremes() || m || {},
                    d = n.dataMin,
                    q = n.dataMax,
