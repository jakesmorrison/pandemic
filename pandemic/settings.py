"""
Django settings for pandemic project.
...
SECRET_KEY = 'p#-h!%k%x*q-^vt@mzc+oa!!*rdr5%gry2vduw7!w6d#v8-&3-'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ["jakobmorrison.net","www.jakobmorrison.net","107.170.195.34"]
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "ROUTING": "pandemic.routing.channel_routing",
    },
}
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'game/templates/game/')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'pandemic.wsgi.application'
...
# ]
STATIC_URL = '/static/'
STATIC_ROOT = '/root/pandemic/static'
